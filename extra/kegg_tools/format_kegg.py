...
ORGANISMS_PATH = join("ftp.kegg.net", "kegg", "genes", "organisms")
OUTPUT_PATH = "kegg-all-orgs_unique_reheader.pep"
...
def read_join_pep_kff(paths:tuple):
    ...
    kff_rws = np.loadtxt(kff_path, dtype='str', delimiter='\n')
...
logging.basicConfig(filename="KEGG_reformat.log", filemode='w',
...
if __name__ == '__main__':
    organisms = [i for i in get_file_sets(ORGANISMS_PATH)] 
